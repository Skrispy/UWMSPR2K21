public class BitString{
    ...
    protected ArrayList<AbstractBit> getAbstractBitList()// adds a bit to the end of the arrayList of bits
    public void addBit(AbstractBit bit)// returns a reference to the bit at location loc in the ArrayList of bits
